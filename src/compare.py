...
def run_model_comparison(
    ...
    for model_name in model_names:
        ...
        results_rows.append({
            ...
            "val_true_positive_rate": val_metrics["true_positive_rate"],
            "val_pred_positive_rate": val_metrics["pred_positive_rate"],
            "val_majority_baseline_accuracy": val_metrics["majority_baseline_accuracy"],
            ...
            "test_true_positive_rate": test_metrics["true_positive_rate"],
            "test_pred_positive_rate": test_metrics["pred_positive_rate"],
            "test_majority_baseline_accuracy": test_metrics["majority_baseline_accuracy"],
        })
